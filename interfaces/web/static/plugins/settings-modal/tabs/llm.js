...
export default {
  ...
  getDefaultMeta(key) {
    ...
    const defaults = {
      ...
      fireworks: { display_name: 'Fireworks', is_local: false, model_options: { 'accounts/fireworks/models/qwen3-235b-a22b-thinking-2507': 'Qwen3 235B Thinking', 'accounts/fireworks/models/glm-5': 'GLM 5' }, required_fields: ['base_url', 'api_key', 'model'], api_key_env: 'FIREWORKS_API_KEY', default_timeout: 10.0 },
      openai: { display_name: 'OpenAI', is_local: false, model_options: { 'gpt-5.2': 'GPT-5.2 (Flagship)', 'gpt-5.2-pro': 'GPT-5.2 Pro', 'gpt-5.1': 'GPT-5.1', 'gpt-5-mini': 'GPT-5 Mini', 'gpt-4o': 'GPT-4o (Legacy)' }, required_fields: ['base_url', 'api_key', 'model'], api_key_env: 'OPENAI_API_KEY', default_timeout: 10.0, supports_reasoning: true },
      responses: { display_name: 'Responses API (Generic)', is_local: false, model_options: null, required_fields: ['base_url', 'api_key', 'model'], default_timeout: 10.0, supports_reasoning: true, description: 'Generic Responses API endpoint (Open Responses standard)' },
